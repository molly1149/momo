...
-- ==========================================
-- HỆ THỐNG HIỂN THỊ "DUNGCU" ĐỘC LẬP
-- ==========================================
local DungCuOverlay = {
    Widget = nil,
    Slot = nil
...
if not isExpired then
    FastTick() 
    Notify("Bạn Đang Chơi Mod Vvip Của Tôi Nếu Chưa Có Key Inbox Tele @dung0610 Zalo 0922520900")
else
    FastTick() 
end
